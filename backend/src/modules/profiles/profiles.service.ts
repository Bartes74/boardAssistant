  ...
  async updateProfile(user: AuthenticatedUser, dto: UpdateProfileDto) {
    ...
    return this.prisma.userProfile.update({
      ...
      data: {
        ...
        responseStyle: dto.response_style ? (dto.response_style as unknown as Prisma.InputJsonValue) : Prisma.JsonNull,
        sourcePrefs: dto.source_prefs ? (dto.source_prefs as unknown as Prisma.InputJsonValue) : Prisma.JsonNull,
      },
    });
  }
}
